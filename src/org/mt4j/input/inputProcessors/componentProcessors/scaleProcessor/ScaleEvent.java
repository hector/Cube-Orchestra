...
public class ScaleEvent extends MTGestureEvent{
	...
	public String toString(){
		return new String(super.toString() + " - " + " Scaleobject:" + this.getTargetComponent().getName() + " X-Scalefactor: " + scaleFactorX + " Y-Scalefactor:" + scaleFactorY + " Z-Scalefactor:" + scaleFactorZ + " Scalingpoint:" + scalingPoint); 
	}
